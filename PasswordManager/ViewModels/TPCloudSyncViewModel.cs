...
{
    public class TPCloudSyncViewModel : ObservableRecipient
    {
        #region Design time instance
        private static readonly Lazy<TPCloudSyncViewModel> _lazy = new(GetDesignTimeVM);
        public static TPCloudSyncViewModel DesignTimeInstance => _lazy.Value;

        private static TPCloudSyncViewModel GetDesignTimeVM()
        {
            var vm = new TPCloudSyncViewModel();
            return vm;
        }
        #endregion
        ...
        private TPCloudSyncViewModel() { }

        public TPCloudSyncViewModel(
